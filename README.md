...
We preformed OLS regession on different features such as adjusted budget. The dependant variables are adjusted revenues and ratings. We were also interested in the R-squared and the significance of the regression's coefficients. (mention that we used bootstra)
